...
if __name__ == "__main__":
    symbols = [ 'ACUTAAS.NS','ADOR.NS','AEQUS.NS','AEROENTER.NS','AEROFLEX.NS','AGIL.NS','AHLWEST.NS','AIAENG.NS','APARINDS.NS','APCOTEXIND.NS','ARSSBL.NS','ASIANENE.NS','AUROPHARMA.NS','AVL.NS','BAJAJST.NS','BERGEPAINT.NS','BHAGCHEM.NS','BHAGYANGR.NS','BHARATSE.NS','BHEL.NS','BIRLACABLE.NS','CAPLIPOINT.NS','CARERATING.NS','CEMPRO.NS','CRAFTSMAN.NS','CUPID.NS','DCXINDIA.NS','DDEVPLSTIK.NS','DEEPAKFERT.NS','DENTA.NS','DIACABS.NS','DSSL.NS','EBGNG.NS','EDELWEISS.NS','EIEL.NS','FAZE3Q.NS','FINEORG.NS','GABRIEL.NS','GALAPREC.NS','GARFIBRES.NS','GOODLUCK.NS','GRWRHITECH.NS','GUJTHEM.NS','GVPIL.NS','GVT&D.NS','HBLENGINE.NS','HFCL.NS','HONASA.NS','INDOAMIN.NS','INDOFARM.NS','INDOTECH.NS','INDSWFTLAB.NS','INOXINDIA.NS','INVPRCQ.NS','IPCALAB.NS','ITCHOTELS.NS','IZMO.NS','JYOTICNC.NS','KIRLPNU.NS','KISSHT.NS','KPIL.NS','KSB.NS','LAURUSLABS.NS','MACPOWER.NS','MENONBE.NS','MODISONLTD.NS','NACLIND.NS','NAVINFLUOR.NS','NELCO.NS','NIACL.NS','NINSYS.NS','NITCO.NS','NRAIL.NS','OFSS.NS','PANAMAPET.NS','PARAS.NS','PARKHOSPS.NS','PGIL.NS','POONAWALLA.NS','POWERICA.NS','PRECOT.NS','PREMEXPLN.NS','PRUDENT.NS','PSPPROJECT.NS','PTCIL.NS','RADICO.NS','RBLBANK.NS','RELTD.NS','RITCO.NS','RML.NS','ROSSARI.NS','SANDHAR.NS','SCHAEFFLER.NS','SCHNEIDER.NS','SEJALLTD.NS','SHAILY.NS','SHILCTECH.NS','SHREEPUSHK.NS','SIGMAADV.NS','SIKA.NS','SPAL.NS','SPMLINFRA.NS','STARHEALTH.NS','SUVEN.NS','SWSOLAR.NS','TARIL.NS','THELEELA.NS','TIMKEN.NS','UFBL.NS','UNIMECH.NS','UNIPARTS.NS','UNIVCABLES.NS','V2RETAIL.NS','VIJAYA.NS','VINDHYATEL.NS','VOLTAMP.NS','WAAREEENER.NS','WAAREEINDO.NS','WABAG.NS','WALCHANNAG.NS','WANBURY.NS','ZENTEC.NS','ZIMLAB.NS', 'AADHARHFC.NS','AARTIPHARM.NS','AGARWALEYE.NS','AVL.NS','BDL.NS','BHARATSE.NS','CARBORUNIV.NS','EDELWEISS.NS','EIHAHOTELS.NS','FINEORG.NS','GABRIEL.NS','GANDHAR.NS','GOKEX.NS','GOODLUCK.NS','HDBFS.NS','ICRA.NS','IVALUE.NS','JBMA.NS','LENSKART.NS','MAFATIND.NS','MALLCOM.NS','OLECTRA.NS','PGIL.NS','PNCINFRA.NS','PUNJABCHEM.NS','RADICO.NS','RANEHOLDIN.NS','REDINGTON.NS','SCHAEFFLER.NS','SEJALLTD.NS','SPLPETRO.NS','STARHEALTH.NS','TATACAP.NS','TCPLPACK.NS','THEJO.NS','TIIL.NS','VENUSPIPES.NS','YATRA.NS','ZIMLAB.NS','ZOTA.NS'
